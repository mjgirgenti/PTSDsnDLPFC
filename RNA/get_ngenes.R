...
gene_counts <- rowSums(data2$RNA@counts)
write.table(gene_counts,glue('/home/ah2428/ShareZhangLab/PTSD/RNA/ngenes/{celltype}_{cond}_gene_counts.txt'),quote=F)

binary_cell_counts <- colSums(bin_counts)
write.table(binary_cell_counts,glue('/home/ah2428/ShareZhangLab/PTSD/RNA/ngenes/{celltype}_{cond}_binary_cell_counts.txt'),quote=F)

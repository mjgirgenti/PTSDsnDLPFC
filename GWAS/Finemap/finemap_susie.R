...
path <- glue('/home/ah2428/palmer_scratch/finemap_final/{gene}.{gwas}.{celltype}.{weight}.plot.pdf')
...
path <- glue('/home/ah2428/palmer_scratch/finemap_final/{gene}.{gwas}.{celltype}.{weight}.result.txt')
write.table(result, path, quote = F, row.names = F)

write.table(rsquared, glue('/home/ah2428/palmer_scratch/finemap_final/{gene}.{gwas}.{celltype}.{weight}.r2.txt'), quote = F, sep='\t')
